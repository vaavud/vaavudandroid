...
import com.vaavud.android.model.S3UploadModel;
...
public class NetworkService extends IntentService {
    ...
    public void onCreate() {
        super.onCreate();
        mTransferManager = new TransferManager(S3Util.getCredProvider(this));
    }
...
//                download(intent.getStringArrayExtra(S3_KEYS_EXTRA));
    ...
    private void abort(int notifId) {
    	S3TransferModel model = S3TransferModel.getTransferModel(notifId);
        model.abort();
    }
...
//    }
    ...
    private void upload(Uri uri) {
        S3UploadModel model = new S3UploadModel(this, uri, mTransferManager);
