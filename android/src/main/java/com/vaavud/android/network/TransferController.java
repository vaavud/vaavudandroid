...
public class TransferController {
    public static void abort(Context context, S3TransferModel model) {
...
//    }
    ...
    public static void pause(Context context, S3TransferModel model) {
        Intent intent = makeIdIntent(context, model.getId());
        intent.setAction(NetworkService.ACTION_PAUSE);
        context.startService(intent);
    }

    public static void resume(Context context, S3TransferModel model) {
        Intent intent = makeIdIntent(context, model.getId());
