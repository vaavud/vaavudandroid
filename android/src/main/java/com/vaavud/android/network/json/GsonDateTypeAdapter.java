...
public class GsonDateTypeAdapter implements JsonSerializer<Date>, JsonDeserializer<Date> {
	...
	@Override
	public JsonElement serialize(Date object, Type typeOfSrc, JsonSerializationContext context) {
		return (object == null) ? JsonNull.INSTANCE : new JsonPrimitive(object.getTime());
	}
